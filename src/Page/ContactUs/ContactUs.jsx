        ...
        <div>
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div className="lg:w-2/3 md:w-1/2 bg-red-300 rounded-lg overflow-hidden sm:mr-10  flex justify-start relative">
                        <img className="block w-full" src="/contuct.jpg" alt="" />
                    </div>
