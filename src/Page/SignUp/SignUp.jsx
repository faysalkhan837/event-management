...
const SignUp = () => {
    ...
    return (
        <section>
            <div className="flex flex-row-reverse min- overflow-hidden">
                        ...
                        <div className="mt-8">
                            <div className="mt-6">
                                <form onSubmit={handleSignUp} method="POST" className="space-y-6">
                                    <div>
                                        <label htmlFor="email" className="block text-sm font-medium text-neutral-600"> Name </label>
                                        <div className="mt-1">
                                            <input id="name" name="name" type="text" autoComplete="name" required placeholder="Your Name" className="block w-full px-5 py-3 text-base placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg text-neutral-600 bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" />
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <p>Already have an acount go to <Link to='/login'><span className="text-blue-500">login</span></Link></p>
